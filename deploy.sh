...
# ── Config ────────────────────────────────────────────────────────────────────
PROJECT_ID="savvy-pagoda-489720-v9"
REGION="us-central1"
SERVICE_NAME="echo"
GCS_BUCKET="${PROJECT_ID}-echo-media"
CLOUD_RUN_URL="https://echo-535359416008.us-central1.run.app"
...
TELEGRAM_BOT_USERNAME=${TELEGRAM_BOT_USERNAME:-GoogleEchoAI_bot},\
